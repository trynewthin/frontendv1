...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.PasswordUpdateDTO();
  });
  ...
  describe('PasswordUpdateDTO', function() {
    it('should create an instance of PasswordUpdateDTO', function() {
      // uncomment below and update the code to test PasswordUpdateDTO
      //var instance = new Api.PasswordUpdateDTO();
      //expect(instance).to.be.a(Api.PasswordUpdateDTO);
    });
